...
OUTPUT_FILES = {
    ...
    "compass_diff": "b_hjn_com_営業決裁_diff.csv",
    "product": "m_商品_all.csv",
    "product_diff": "m_商品_all_diff.csv",
    "corp_all_1": "m_hjn_smt_統一企業情報_1.csv",
    "corp_all_2": "m_hjn_smt_統一企業情報_2.csv",
    "corp_diff": "m_hjn_smt_統一企業情報_diff.csv",
    "bfs_all": "b_hjn_bfs_モバイル_エントリ情報.csv",
    "bfs_diff": "b_hjn_bfs_モバイル_エントリ情報_diff.csv",
    "bfs_device_all": "b_hjn_bfs_モバイル_サービスサマリ_端末.csv",
    "bfs_device_diff": "b_hjn_bfs_モバイル_サービスサマリ_端末_diff.csv",
    "bfs_accessories_all": "b_hjn_bfs_モバイル_サービスサマリ_付属品.csv",
    "bfs_accessories_diff": "b_hjn_bfs_モバイル_サービスサマリ_付属品_diff.csv",
}

...
FULL_GZIP_SIZE_TARGETS = {
    "agency_all": 255_000_000,
    "compass_all": 200_000_000,
    "product": 8_100_000,
    "product_diff": 8_100_000,
    "corp_all": 900_000_000,
    "bfs_all": 461_000_000,
    "bfs_device_all": 190_000_000,
    "bfs_accessories_all": 5_000_000,
}
FULL_GZIP_SIZE_PROFILES = {
    "agency_all": {"padding": 50},
...
OUTPUT_FILES = {
    "campaign": "DLV_OAI_MRS_CMPGN.csv",
    "campaign_diff": "DLV_OAI_MRS_CMPGN_diff.csv",
    "agency_all": "DLV_OAI_CST_ORDCSTM.csv",
    "agency_diff": "DLV_OAI_CST_ORDCSTM_diff.csv",
    "compass_all": "DLV_OAI_COM_EIG_KESSAI.csv",
    "compass_diff": "DLV_OAI_COM_EIG_KESSAI_diff.csv",
    "product": "DLV_OAI_MRS_ITEM.csv",
    "product_diff": "DLV_OAI_MRS_ITEM_diff.csv",
    "corp_all": "DLV_OAI_SMT_DV_SMT_MST_UNIQ_CORP_IE.csv",
    "corp_diff": "DLV_OAI_SMT_DV_SMT_MST_UNIQ_CORP_IE_diff.csv",
    "bfs_all": "DLV_OAI_BFS_BFS_ENTRY_INFO.csv",
    "bfs_diff": "DLV_OAI_BFS_BFS_ENTRY_INFO_diff.csv",
    "bfs_device_all": "DLV_OAI_BFS_BFS_SERVICE_SUMMARY4.csv",
    "bfs_device_diff": "DLV_OAI_BFS_BFS_SERVICE_SUMMARY4_diff.csv",
    "bfs_accessories_all": "DLV_OAI_BFS_BFS_ATTACHMENT_SUMMALLY.csv",
    "bfs_accessories_diff": "DLV_OAI_BFS_BFS_ATTACHMENT_SUMMALLY_diff.csv",
}

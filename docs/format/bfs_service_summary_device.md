...
| 項目名 | カラム名 | 型 | 桁 | 必須 | 説明 |
| --- | --- | --- | --- | --- | --- |
| エントリ番号 | `entry_no` | VARCHAR | 18 | ⚪︎ | - |
| サマリ番号 | `svcsm_id` | VARCHAR | 12 | ⚪︎ | - |
| 回線数 | `linenum` | DECIMAL | 10 | － | - |
| レンタルセット端末 | `rental_set_terminal_flg_nm` | VARCHAR | 765 | － | 有 / 無 |
| mnp | `mnp_flg_nm` | VARCHAR | 765 | － | 有 / 無 |
| 商品コード | `itm_cd` | VARCHAR | 15 | ⚪︎ | - |
| メーカ | `brand_nm` | VARCHAR | 600 | ⚪︎ | - |
| 移動機分類 | `itm_middle_grp_nm` | VARCHAR | 300 | ⚪︎ | - |
| 機種名 | `itm_nm` | VARCHAR | 300 | ⚪︎ | - |
...
| プラン | `cate01` | VARCHAR | 600 | ⚪︎ | 基本プラン（音声）、基本プラン（データ）、通話定額基本料（ケータイ）、ホワイト特別相対S、ホワイト特別相対L など |
